package com.hedgefund.bls.store;
...
public class BlsBronzeWriter {
    private static final Logger log = LoggerFactory.getLogger(BlsBronzeWriter.class);
    private final BronzeWriter delegate;

    public BlsBronzeWriter(Path bronzeRoot) {
