...
public class Main {
    public static void main(String[] args) throws Exception {
        String cfgPath="config/binance/binance.yaml";
        ...
        BinanceConfig cfg=Files.exists(cfgFile)? BinanceConfig.fromYaml(cfgFile): BinanceConfig.defaults();
        ...
        System.out.println("binance ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
