...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        if (Files.exists(centralizedPath)) {
            ...
            cfg = Files.exists(cfgFile) ? CalcfiConfig.fromYaml(cfgFile) : CalcfiConfig.defaults();
        }
        ...
        System.out.println("Calcfi ingest done. Bronze=" + root.resolve(cfg.ingestConfig().paths().bronze()) + " Silver=" + root.resolve(cfg.ingestConfig().paths().silver()));
    }
}
