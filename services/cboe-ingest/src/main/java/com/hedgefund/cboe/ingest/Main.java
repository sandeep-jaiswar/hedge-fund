...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        CboeConfig cfg=Files.exists(cfgFile)? CboeConfig.fromYaml(cfgFile): CboeConfig.defaults();
        ...
        System.out.println("cboe ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
