...
public class Main {
    public static void main(String[] args) throws Exception {
        String cfgPath="config/coinbase/coinbase.yaml";
        ...
        CoinbaseConfig cfg=Files.exists(cfgFile)? CoinbaseConfig.fromYaml(cfgFile): CoinbaseConfig.defaults();
        ...
        System.out.println("coinbase ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
