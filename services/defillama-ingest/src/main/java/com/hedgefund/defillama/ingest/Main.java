...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        DefillamaConfig cfg=Files.exists(cfgFile)? DefillamaConfig.fromYaml(cfgFile): DefillamaConfig.defaults();
        ...
        System.out.println("defillama ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
