...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        EiaConfig cfg=Files.exists(cfgFile)? EiaConfig.fromYaml(cfgFile): EiaConfig.defaults();
        ...
        System.out.println("eia ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
