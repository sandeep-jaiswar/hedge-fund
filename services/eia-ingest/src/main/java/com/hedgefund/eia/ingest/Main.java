...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String cfgPath = "config/eia/eia.yaml";
        ...
        if (Files.exists(centralizedPath)) {
            ...
            cfg = Files.exists(cfgFile) ? EiaConfig.fromYaml(cfgFile) : EiaConfig.defaults();
        }
        ...
        System.out.println("EIA ingest done. Bronze=" + root.resolve(cfg.ingestConfig().paths().bronze()) + " Silver=" + root.resolve(cfg.ingestConfig().paths().silver()));
    }
}
