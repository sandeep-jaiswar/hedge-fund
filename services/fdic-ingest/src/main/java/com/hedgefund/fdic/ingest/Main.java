...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        FdicConfig cfg=Files.exists(cfgFile)? FdicConfig.fromYaml(cfgFile): FdicConfig.defaults();
        ...
        System.out.println("fdic ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
