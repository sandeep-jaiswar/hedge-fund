...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String cfgPath = "config/fdic/fdic.yaml";
        ...
        if (Files.exists(centralizedPath)) {
            ...
            cfg = Files.exists(cfgFile) ? FdicConfig.fromYaml(cfgFile) : FdicConfig.defaults();
        }
        ...
        System.out.println("FDIC ingest done. Bronze=" + root.resolve(cfg.ingestConfig().paths().bronze()) + " Silver=" + root.resolve(cfg.ingestConfig().paths().silver()));
    }
}
