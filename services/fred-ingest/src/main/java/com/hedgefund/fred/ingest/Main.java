...
public class Main {
    public static void main(String[] args) throws Exception {
        String cfgPath="config/fred/fred.yaml";
        ...
        FredConfig cfg=Files.exists(cfgFile)? FredConfig.fromYaml(cfgFile): FredConfig.defaults();
        ...
        System.out.println("fred ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
