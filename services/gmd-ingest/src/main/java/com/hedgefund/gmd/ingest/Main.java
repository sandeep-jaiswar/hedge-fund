...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        GmdConfig cfg=Files.exists(cfgFile)? GmdConfig.fromYaml(cfgFile): GmdConfig.defaults();
        ...
        System.out.println("gmd ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
