...
public class Main {
    public static void main(String[] args) throws Exception {
        String cfgPath="config/imf/imf.yaml";
        ...
        ImfConfig cfg=Files.exists(cfgFile)? ImfConfig.fromYaml(cfgFile): ImfConfig.defaults();
        ...
        System.out.println("imf ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
