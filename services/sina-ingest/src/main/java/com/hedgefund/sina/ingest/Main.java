...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        SinaConfig cfg=Files.exists(cfgFile)? SinaConfig.fromYaml(cfgFile): SinaConfig.defaults();
        ...
        System.out.println("sina ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
