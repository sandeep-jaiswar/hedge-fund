...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        TencentConfig cfg=Files.exists(cfgFile)? TencentConfig.fromYaml(cfgFile): TencentConfig.defaults();
        ...
        System.out.println("tencent ingest done. Bronze="+root.resolve(cfg.paths().bronze())+" Silver="+root.resolve(cfg.paths().silver()));
    }
}
