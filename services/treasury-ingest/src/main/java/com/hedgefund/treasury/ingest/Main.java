...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (Files.exists(centralizedPath)) {
            ...
            cfg = Files.exists(cfgFile) ? TreasuryConfig.fromYaml(cfgFile) : TreasuryConfig.defaults();
        }
        ...
        System.out.println("treasury ingest done. Bronze=" +
